...
interface MedicalProfileAllergiesFormProps {
  showOnlyAllergies?: boolean;
  showOnlyImmunizations?: boolean;
}

const MedicalProfileAllergiesForm: React.FC<MedicalProfileAllergiesFormProps> = ({ 
  showOnlyAllergies = false,
  showOnlyImmunizations = false
}) => {
  // State for allergies
  ...
  // If we're only showing allergies section
  ...
  // If we're only showing immunizations section
  if (showOnlyImmunizations) {
    return (
      <div className="space-y-8">
        <div>
  ...
  // Default view with both sections
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-medium mb-4">Allergies</h3>
