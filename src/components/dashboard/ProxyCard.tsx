...
import { MoreHorizontal, UserCheck, Mail, Calendar } from 'lucide-react';
import { 
  DropdownMenu, 
  DropdownMenuContent, 
  DropdownMenuItem, 
...
const ProxyCard: React.FC<ProxyCardProps> = ({ proxy, onRemove, onUpdateAccess }) => {
        ...
        <div className="flex justify-between items-start">
          <div className="flex items-center space-x-4">
            <div className="bg-safet-50 p-2 rounded-full">
              <UserCheck className="h-6 w-6 text-safet-500" />
            </div>
            <div>
              ...
              <div className="flex items-center text-xs text-gray-500 mt-1">
                ...
                Added {formatDate(proxy.dateAdded)}
              </div>
